...
class PPOAgent:
    ...
    def actor_network(self):
        ...
        # l2 = keras.layers.Dense(320, activation='relu')(l1)
        # l3 = keras.layers.Dense(320, activation='relu')(l2)
        ...
        # mu = keras.layers.Dense(self.action_size, activation='tanh')(l4)
        # sigma = keras.layers.Dense(self.action_size, activation="softplus")(l4) # need to change the output activation function
        # self.norm_dist = keras.backend.random_normal((1, 2), mean=mu, stddev=sigma)
    ...
    def process_memory(self):
        ...
        value_estimates = self.critic_model.predict([visual_observations,vector_states]) # maybe need to flatten
